                ...
                <form acton="userProfile" id="form" method="post" name="pop">
                    ...
                    <div class="modal-body">
                        <div class="input-group">
                            ...
                            <div class="form-group is-empty"><input name="oldPw" type="Password" class="form-control" placeholder="Old Password"></div>
                        </div>
                        <div class="input-group">
                        ...
                        <input name="newPw" id="newPw" type="Password" class="form-control" placeholder="New Password"></div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">Confirm new password:
                                <i class="material-icons">lock_outline</i>
                            </span>
                            <div class="form-group is-empty">
                        <input name="confirmNewPw" id="confirmNewPw" type="Password" class="form-control" placeholder="Confirm New Password"></div>
                        </div>
                        

                    </div>
                    <div class="modal-footer">
                        <input class="btn btn-primary btn-simple"  value="submit" onclick="checkPwd()"/>
...
<c:if test="${!(empty param.result) && param.result eq 'false'}">
    ...
    <script>
        function checkPwd(loc){
            if(!($("#newPw").val()==$("#confirmNewPw").val()))
                alert("New password must be equals!")
            else
                $("#form").submit()
        }
    </script>